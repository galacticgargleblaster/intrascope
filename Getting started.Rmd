...
plt.title(f"{YOU}'s login time by host from {start_approx} to {end_approx}");
...
- How much do different cadets in different zones move around?
...
# This is f'd: don't overwrite the dataframe in place.  Make new series instead
